...
var Game = function(client) {
	...
	this.audioManager.load("../audio/you.ogg");
	this.audioManager.load("../audio/subtle.ogg");
	this.audioManager.load("../audio/none.ogg");
	this.audioManager.load("../audio/game-is-over.ogg");
...
Game.prototype = {
	...
	_updateOthers : function() {
		...
		if (this.gameState.isTerminal()) {
			...
			this.audioManager.play("../audio/game-is-over.ogg");
			...
			if (this.currentColor == this.gameState.getColor())
				this.audioManager.play("../audio/you.ogg");
		}
	},
	...
	bigMess : function() {
		...
		var potentialCellClickEventHandler = function(event) {
			...
			// cf http://bugs.jquery.com/ticket/8523
