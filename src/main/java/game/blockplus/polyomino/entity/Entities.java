...
import game.blockplus.polyomino.projection.Plane;
...
public final class Entities {
    ...
    private IEntity get(final String id, final Set<Position> normalizedPositions) {
        ...
        if (entity == null) {
            ...
            //            System.out.println("-> into database: " + computedEntity.type() + " : " + computedEntity.id);
            //            if (!normalizedPositions.isEmpty()) {
            //                final PieceInstances pieceInstances = new PieceInstances(Plane.from(20, 20));
            //                final Iterable<PieceInstance> iterable = pieceInstances.from(computedEntity);
            //                final PieceInstance instance = iterable.iterator().next();
            //                System.out.println(instance.referential());
            //                System.out.println(instance);
            //            }
        }
        //        else System.out.println("from database: " + entity.type() + " : " + ((ComputedEntity) entity).id);
        return entity;
    }

    // TODO index DB: OK !
    // TODO cache intermédiaire: OK !
    // TODO cache des instances d'une entité: ...
    public static void main(final String[] args) {

        // 35216 instances
        // 30434/30433 in DB : 30433
        // TODO comprendre d'ou vient la différence: piece nulle ;)
