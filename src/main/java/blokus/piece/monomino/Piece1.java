...
public class Piece1 implements PieceInterface {
    ...
    */
    ...
    private final static int NUMBER_OF_CELL = 1;
    ...
    */
    ...
    private Piece1(final Matrix matrix) {
        this.matrix = matrix;
    }
    ...
    @Override
    public Piece1 newInstance(final Matrix matrix) {
        return new Piece1(matrix);
    }
    ...
    public static void main(final String[] args) {
        ...
        final PieceInterface pieceA = new Piece1();
