...
public class Piece7 implements PieceInterface {
    ...
    */
    ...
    private Piece7(final Matrix matrix) {
        this.matrix = matrix;
    }
    ...
    @Override
    public Piece7 newInstance(final Matrix matrix) {
        return new Piece7(matrix);
    }
    ...
    public static void main(final String[] args) {
        ...
        final PieceInterface pieceA = new Piece7();
