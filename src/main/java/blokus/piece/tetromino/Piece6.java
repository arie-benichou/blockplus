...
public class Piece6 implements PieceInterface {
    ...
    */
    ...
    private Piece6(final Matrix matrix) {
        this.matrix = matrix;
    }
    ...
    @Override
    public Piece6 newInstance(final Matrix matrix) {
        return new Piece6(matrix);
    }
    ...
    public static void main(final String[] args) {
        ...
        final PieceInterface pieceA = new Piece6();
