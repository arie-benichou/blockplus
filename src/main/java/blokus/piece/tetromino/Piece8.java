...
public class Piece8 implements PieceInterface {
    ...
    */
    ...
    private Piece8(final Matrix matrix) {
        this.matrix = matrix;
    }
    ...
    @Override
    public Piece8 newInstance(final Matrix matrix) {
        return new Piece8(matrix);
    }
    ...
    public static void main(final String[] args) {
        ...
        final PieceInterface pieceA = new Piece8();
