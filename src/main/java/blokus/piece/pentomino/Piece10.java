...
public class Piece10 implements PieceInterface {
    ...
    */
    ...
    private Piece10(final Matrix matrix) {
        this.matrix = matrix;
    }
    ...
    @Override
    public Piece10 newInstance(final Matrix matrix) {
        return new Piece10(matrix);
    }
    ...
    public static void main(final String[] args) {
        ...
        final PieceInterface pieceA = new Piece10();
