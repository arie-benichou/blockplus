...
public class Piece15 implements PieceInterface {
    ...
    */
    ...
    private Piece15(final Matrix matrix) {
        this.matrix = matrix;
    }
    ...
    @Override
    public Piece15 newInstance(final Matrix matrix) {
        return new Piece15(matrix);
    }
    ...
    public static void main(final String[] args) {
        ...
        final PieceInterface pieceA = new Piece15();
