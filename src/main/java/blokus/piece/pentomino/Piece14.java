...
public class Piece14 implements PieceInterface {
    ...
    */
    ...
    private Piece14(final Matrix matrix) {
        this.matrix = matrix;
    }
    ...
    @Override
    public Piece14 newInstance(final Matrix matrix) {
        return new Piece14(matrix);
    }
    ...
    public static void main(final String[] args) {
        ...
        final PieceInterface pieceA = new Piece14();
