...
public class Piece20 implements PieceInterface {
    ...
    */
    ...
    private Piece20(final Matrix matrix) {
        this.matrix = matrix;
    }
    ...
    @Override
    public Piece20 newInstance(final Matrix matrix) {
        return new Piece20(matrix);
    }
    ...
    public static void main(final String[] args) {
        ...
        final PieceInterface pieceA = new Piece20();
