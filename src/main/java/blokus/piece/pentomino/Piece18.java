...
public class Piece18 implements PieceInterface {
    ...
    */
    ...
    private Piece18(final Matrix matrix) {
        this.matrix = matrix;
    }
    ...
    @Override
    public Piece18 newInstance(final Matrix matrix) {
        return new Piece18(matrix);
    }
    ...
    public static void main(final String[] args) {
        ...
        final PieceInterface pieceA = new Piece18();
