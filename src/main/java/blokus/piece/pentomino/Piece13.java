...
public class Piece13 implements PieceInterface {
    ...
    */
    ...
    private Piece13(final Matrix matrix) {
        this.matrix = matrix;
    }
    ...
    @Override
    public Piece13 newInstance(final Matrix matrix) {
        return new Piece13(matrix);
    }
    ...
    public static void main(final String[] args) {
        ...
        final PieceInterface pieceA = new Piece13();
