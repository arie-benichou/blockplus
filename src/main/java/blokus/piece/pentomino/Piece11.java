...
public class Piece11 implements PieceInterface {
    ...
    */
    ...
    private Piece11(final Matrix matrix) {
        this.matrix = matrix;
    }
    ...
    @Override
    public Piece11 newInstance(final Matrix matrix) {
        return new Piece11(matrix);
    }
    ...
    public static void main(final String[] args) {
        ...
        final PieceInterface pieceA = new Piece11();
