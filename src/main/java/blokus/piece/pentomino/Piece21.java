...
public class Piece21 implements PieceInterface {
    ...
    */
    ...
    private Piece21(final Matrix matrix) {
        this.matrix = matrix;
    }
    ...
    @Override
    public Piece21 newInstance(final Matrix matrix) {
        return new Piece21(matrix);
    }
    ...
    public static void main(final String[] args) {
        ...
        final PieceInterface pieceA = new Piece21();
