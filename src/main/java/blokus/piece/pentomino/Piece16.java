...
public class Piece16 implements PieceInterface {
    ...
    */
    ...
    private Piece16(final Matrix matrix) {
        this.matrix = matrix;
    }
    ...
    @Override
    public Piece16 newInstance(final Matrix matrix) {
        return new Piece16(matrix);
    }
    ...
    public static void main(final String[] args) {
        ...
        final PieceInterface pieceA = new Piece16();
