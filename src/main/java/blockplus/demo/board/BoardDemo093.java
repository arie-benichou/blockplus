 ...
 * White color
 */
public final class BoardDemo093 {
    ...
    public static void main(final String[] args) throws InterruptedException {
        ...
        // TODO ! extract view
        final Map<Concurrency, Color> colorByLightConcurrency = new ImmutableMap.Builder<Concurrency, Color>()
        ...
        final SwingRendering remainingSpaceView = new SwingRendering(colorByLightConcurrency);

        remainingSpaceView.apply(newBoard.getLightConcurrency(Blue));
