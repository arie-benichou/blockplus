...
import blockplus.model.board.Capacity;
 ...
 * White color
 */
public final class BoardDemo092 {
    ...
    public static void main(final String[] args) throws InterruptedException {
        ...
        final Map<Capacity, Color> colorByRemainingSpace = new ImmutableMap.Builder<Capacity, Color>()
                .put(Capacity.NONE, new Color(255, 255, 255, 0))
                .put(Capacity.ONE, new Color(255, 255, 255, 60))
                .put(Capacity.TWO, new Color(255, 255, 255, 120))
                .put(Capacity.THREE, new Color(255, 255, 255, 180))
                .put(Capacity.FOUR, new Color(255, 255, 255, 255))
                .build();

        final SwingRendering remainingSpaceView = new SwingRendering(colorByRemainingSpace);

        remainingSpaceView.apply(newBoard.getCapacity(Blue));
